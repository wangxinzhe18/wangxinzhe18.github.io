...
$.ajax({
    ...
    data: {
        key: 'J7KBZ-YMOKN-VLNF4-SO3MH-6B56T-2TBP4',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(114.295589,30.708771,ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
